...
class CrossSelfAttention(nn.Module):
    ...
    def forward(self,wordgrid,question):
        ...
        question = F.normalize(question,p=1,dim=1)
        ...
        #.permute((0,2,3,1)).view(batch_size,-1,self.vector_dim)
...
class SANVQA(nn.Module):
    ...
    def forward(self, image, question, question_len, embeddings, bboxes, emb_lengths):  # this is an image blind example (as in section 4.1)
        ...
        #Denote if word is from wordgrid
        #(12,50)
        ...
        wordgrid = torch.zeros((batch_size,350,56,56),device=device)
        ...
        wordgrid = self.cross_self_attention(wordgrid,question)
        ...
        return weighted_avg_wordgrid,question,wordgrid.view(batch_size,emb_size,h,w)